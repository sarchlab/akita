...
// Source: github.com/sarchlab/akita/v4/sim/hardware (interfaces: Port,Connection,Component)
...
import (
	...
	hardware "github.com/sarchlab/akita/v4/sim/hardware"
...
func (m *MockPort) AsRemote() hardware.RemotePort {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AsRemote")
	ret0, _ := ret[0].(hardware.RemotePort)
	return ret0
}
...
func (m *MockPort) Component() hardware.Component {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Component")
	ret0, _ := ret[0].(hardware.Component)
	return ret0
}
...
func (m *MockPort) Deliver(arg0 hardware.Msg) *hardware.SendError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Deliver", arg0)
	ret0, _ := ret[0].(*hardware.SendError)
	return ret0
}
...
func (m *MockPort) PeekIncoming() hardware.Msg {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PeekIncoming")
	ret0, _ := ret[0].(hardware.Msg)
	return ret0
}
...
func (m *MockPort) PeekOutgoing() hardware.Msg {
	m.ctrl.T.Helper()
...
func (m *MockPort) RetrieveIncoming() hardware.Msg {
	m.ctrl.T.Helper()
...
func (m *MockPort) RetrieveOutgoing() hardware.Msg {
	m.ctrl.T.Helper()
...
func (m *MockPort) Send(arg0 hardware.Msg) *hardware.SendError {
	m.ctrl.T.Helper()
...
func (m *MockPort) SetConnection(arg0 hardware.Connection) {
	m.ctrl.T.Helper()
...
// NotifyAvailable mocks base method.
func (m *MockConnection) NotifyAvailable(arg0 hardware.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) PlugIn(arg0 hardware.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) Unplug(arg0 hardware.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) AddPort(arg0 string, arg1 hardware.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) GetPortByName(arg0 string) hardware.Port {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPortByName", arg0)
	ret0, _ := ret[0].(hardware.Port)
	return ret0
}
...
func (m *MockComponent) NotifyPortFree(arg0 hardware.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) NotifyRecv(arg0 hardware.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) Ports() []hardware.Port {
	m.ctrl.T.Helper()
