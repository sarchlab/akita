...
class TaskRenderer {
    ...
    _showMilestoneGroupTooltip(milestoneGroup, event) {
        ...
        let content = `<div style="text-align: left; min-width: 310px;">
            <h4>Milestone${steps.length > 1 ? 's' : ''} at ${smartTimeString(milestoneGroup.time)}</h4>`;
...
<div class="container">
    ...
    <dl class="row">
        ...
        <dd class="col-sm-${tableRightcol}">
            ${smartTimeString(task['start_time'])}
        </dd>

        <dt class="col-sm-${tableLeftCol}">End</dt>
        <dd class="col-sm-${tableRightcol}">
            ${smartTimeString(task['end_time'])}
        </dd>

        <dt class="col-sm-${tableLeftCol}">Duration</dt>
        <dd class="col-sm-${tableRightcol}">
            ${smartTimeString(task['end_time'] - task['start_time'])}
        </dd>
    </dl>
</div>`
    ...
    _showMilestoneTooltip(step, event) {
        ...
        <div class="container">
            ...
            <dl class="row">
                ...
                <dd class="col-sm-${tableRightCol}">${smartTimeString(step.time)}</dd>
