...
// Source: gitlab.com/yaotsu/core/requestsys (interfaces: Component)
...
func (_m *MockComponent) CanRecv(_param0 *requestsys.Request) *requestsys.ConnError {
...
func (_m *MockComponent) Connect(_param0 string, _param1 requestsys.Connection) error {
...
func (_m *MockComponent) GetConnection(_param0 string) requestsys.Connection {
	ret := _m.ctrl.Call(_m, "GetConnection", _param0)
	ret0, _ := ret[0].(requestsys.Connection)
	return ret0
}
...
func (_m *MockComponent) Recv(_param0 *requestsys.Request) *requestsys.ConnError {
