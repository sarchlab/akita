...
//go:generate mockgen -destination "mock_tags_test.go" -package $GOPACKAGE -write_package_comment=false github.com/sarchlab/akita/v4/mem/cache/internal/tagging TagArray,VictimFinder
