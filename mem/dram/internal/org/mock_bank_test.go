...
//
//	mockgen -source bank.go -destination mock_bank_test.go -self_package github.com/sarchlab/akita/v4/mem/dram/internal/org -package org
//
...
func (mr *MockBankMockRecorder) AcceptHook(hook any) *gomock.Call {
...
func (mr *MockBankMockRecorder) GetReadyCommand(cmd any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBankMockRecorder) InvokeHook(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBankMockRecorder) StartCommand(cmd any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBankMockRecorder) UpdateTiming(cmdKind, cycleNeeded any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
