...
Akita v5 will be the biggest refactor of the Akita simulator engine since the beginning of the project. The goal is to reconsider every design decisions made while developing from v1 to v4 version of Akita. 
