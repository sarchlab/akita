...
type splitHandler[StateType] struct {
	rng        *rand.Rand
	population StateType 
}

func (h *splitHandler) Handle[StateType](evt splitEvent) (StateType) {
...
func main() {
	...
	populationHandle := simulation.MustRegisterStateHandle("cells/population", StateType{
		Cells: 1,
	}).(stateHandle)
