...
// Source: github.com/sarchlab/akita/v5/sim (interfaces: Port,Engine,Event,Connection,Component,Handler,Ticker)
//
// Generated by this command:
//
//	mockgen -destination mock_sim_test.go -self_package=github.com/sarchlab/akita/v5/noc/directconnection -package directconnection -write_package_comment=false github.com/sarchlab/akita/v5/sim Port,Engine,Event,Connection,Component,Handler,Ticker
//
...
// NumIncoming mocks base method.
func (m *MockPort) NumIncoming() int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NumIncoming")
	ret0, _ := ret[0].(int)
	return ret0
}

// NumIncoming indicates an expected call of NumIncoming.
func (mr *MockPortMockRecorder) NumIncoming() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NumIncoming", reflect.TypeOf((*MockPort)(nil).NumIncoming))
}

// NumOutgoing mocks base method.
func (m *MockPort) NumOutgoing() int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NumOutgoing")
	ret0, _ := ret[0].(int)
	return ret0
}

// NumOutgoing indicates an expected call of NumOutgoing.
func (mr *MockPortMockRecorder) NumOutgoing() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NumOutgoing", reflect.TypeOf((*MockPort)(nil).NumOutgoing))
}
...
func (mr *MockPortMockRecorder) SetComponent(comp any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetComponent", reflect.TypeOf((*MockPort)(nil).SetComponent), comp)
}
...
// NotifyAvailable mocks base method.
func (m *MockConnection) NotifyAvailable(port messaging.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) PlugIn(port messaging.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) Unplug(port messaging.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) AddPort(name string, port messaging.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) GetPortByName(name string) messaging.Port {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPortByName", name)
	ret0, _ := ret[0].(messaging.Port)
	return ret0
}
...
func (m *MockComponent) NotifyPortFree(port messaging.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) NotifyRecv(port messaging.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) Ports() []messaging.Port {
	m.ctrl.T.Helper()
...
func (m *MockHandler) Handle(e timing.Event) error {
	m.ctrl.T.Helper()
...
func (mr *MockHandlerMockRecorder) Handle(e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
