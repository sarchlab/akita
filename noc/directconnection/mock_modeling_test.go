...
// Source: github.com/sarchlab/akita/v4/sim/modeling (interfaces: Port,Connection,Component)
...
// NotifyAvailable mocks base method.
func (m *MockConnection) NotifyAvailable(arg0 modeling.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) PlugIn(arg0 modeling.Port) {
	m.ctrl.T.Helper()
...
func (m *MockConnection) Unplug(arg0 modeling.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) AddPort(arg0 string, arg1 modeling.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) GetPortByName(arg0 string) modeling.Port {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPortByName", arg0)
	ret0, _ := ret[0].(modeling.Port)
	return ret0
}
...
func (m *MockComponent) NotifyPortFree(arg0 modeling.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) NotifyRecv(arg0 modeling.Port) {
	m.ctrl.T.Helper()
...
func (m *MockComponent) Ports() []modeling.Port {
	m.ctrl.T.Helper()
