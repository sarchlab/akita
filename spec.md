...
The `writethroughcache` package (`v5/mem/cache/writethroughcache/`) should be renamed to reflect its write-through nature. The package name, directory, doc comments, and all external references should use the new name.
...
9. **Default spec, rename writethroughcache, freq in spec** (issue #384): See sections above.
