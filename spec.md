...
30. ~~**Dedicated hooking package** (issue #595)~~: **DONE in M69.1** — `v5/hooking` created with generic hook primitives; `sim` compatibility aliases/shims in place (PR #106 merged).
