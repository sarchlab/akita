...
- Use the checked-in Go baseline: `go.mod:51-53` pins `go 1.26.0` with `toolchain go1.26.2`, and `TOOLCHAIN_VERSIONS.md:8-16` records the same security-remediated toolchain baseline.
