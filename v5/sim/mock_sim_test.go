...
//
//	mockgen -destination mock_sim_test.go -self_package=github.com/sarchlab/akita/v5/sim -package sim -write_package_comment=false github.com/sarchlab/akita/v5/sim Port,Engine,Event,Connection,Component,Handler,Ticker
//
