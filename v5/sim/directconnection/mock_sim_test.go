...
//
//	mockgen -destination sim/directconnection/mock_sim_test.go -self_package=github.com/sarchlab/akita/v5/sim/directconnection -package directconnection -write_package_comment=false github.com/sarchlab/akita/v5/sim Port,Engine,Event,Connection,Component,Handler,Ticker
//
...
func (m *MockEvent) Handler() sim.Handler {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handler")
	ret0, _ := ret[0].(sim.Handler)
	return ret0
}
...
func (m *MockEvent) Time() sim.VTimeInSec {
	m.ctrl.T.Helper()
...
// Handle mocks base method.
func (m *MockHandler) Handle(e sim.Event) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handle", e)
	ret0, _ := ret[0].(error)
	return ret0
