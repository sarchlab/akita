...
// Spec contains immutable configuration for the writethrough cache.
type Spec struct {
...
// State contains mutable runtime data for the writethrough cache.
type State struct {
...
// pipelineMW holds all non-serializable infrastructure for the writethrough
