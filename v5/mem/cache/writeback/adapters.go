...
// --- stateTransBuffer ---
// Wraps pointers to []int (transaction indices in inFlightTransactions).
...
// Wraps read/write pointers to []int (transaction indices). Peek/Pop return bankPipelineElem.
