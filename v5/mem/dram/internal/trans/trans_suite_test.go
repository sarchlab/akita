...
//go:generate mockgen -source commandcreator.go -destination mock_commandcreator_test.go -self_package github.com/sarchlab/akita/v5/mem/dram/internal/trans -package $GOPACKAGE
