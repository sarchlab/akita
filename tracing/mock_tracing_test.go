...
// Source: github.com/sarchlab/akita/v4/tracing (interfaces: NamedHookable,TaskPrinter)
//
// Generated by this command:
//
//	mockgen -destination mock_tracing_test.go -package tracing -write_package_comment=false github.com/sarchlab/akita/v4/tracing NamedHookable,TaskPrinter
//
...
func (mr *MockTaskPrinterMockRecorder) Print(task any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Print", reflect.TypeOf((*MockTaskPrinter)(nil).Print), task)
}
