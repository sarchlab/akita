...
// Source: gitlab.com/yaotsu/core/conn (interfaces: Connection)
...
func (_m *MockConnection) Register(_param0 conn.Connectable) error {
...
func (_m *MockConnection) Unregister(_param0 conn.Connectable) error {
